...
import { FiUser, FiMail, FiLock, FiArrowRight, FiShield, FiBriefcase, FiAward } from 'react-icons/fi';
        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-16">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-blue-400 pl-6">
              <p className="text-2xl font-light text-white leading-relaxed">
                "Join the future of<br />legal practice management."
              </p>
              <p className="text-blue-300 mt-4 flex items-center">
                <span className="w-8 h-px bg-blue-400 mr-3"></span>
          ...
          <div>
            <p className="text-blue-300 text-sm">
              © 2024 TheAdvocate. All rights reserved.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="mt-2 text-gray-600">
              Join TheAdvocate to manage your legal practice
            </p>
          </div>
